...
<div class="bg-white p-6 rounded shadow mb-4">
    @auth
        ...
        <!-- Tampilkan tombol untuk ke halaman admin dashboard -->
        @if (Auth::user()->role === 'admin')
            <a href="{{ route('admin.dashboard') }}" class="inline-block bg-blue-600 text-white px-6 py-2 rounded-full hover:bg-blue-700 transition duration-300">
                Dashboard Admin
            </a>
        @endif
    @else
